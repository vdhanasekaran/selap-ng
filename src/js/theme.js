...
$(function() {
  ...
  $(document).on("click", '[data-toggle="lightbox"]', function(event) {
    ...
    $(this).ekkoLightbox({
      ...
      leftArrow:
        '<span><img src="' +
        basePath +
        'src/img/prev.svg" class="nav-arrow nav-arrow-left" alt="" width="50"></span>',
      rightArrow:
        '<span><img src="' +
        basePath +
        'src/img/next.svg" class="nav-arrow nav-arrow-right" alt="" width="50"></span>'
    });
  });
  ...
  homeSlider.owlCarousel({
    ...
    responsiveClass: true,
    navText: [
      '<img src="' + basePath + 'src/img/prev.svg" alt="" width="50">',
      '<img src="' + basePath + 'src/img/next.svg" alt="" width="50">'
    ],
    responsive: {
      0: {
        items: 1,
